        ...
        <>
            ...
            <main className="min-h-screen bg-cream pt-24">
                <div className="container mx-auto px-6 max-w-5xl py-16">
                    <h1 className="text-5xl font-bold mb-8 text-seth-coral">{t("title")}</h1>
                    ...
                    <div className="mt-16 pt-8 border-t border-seth-coral/20">
                        <h2 className="text-3xl font-bold mb-4 text-seth-coral">{t("contactTitle")}</h2>
                        <p className="text-lg text-seth-coral mb-4">{t("contactMessage")}</p>
                        <a
