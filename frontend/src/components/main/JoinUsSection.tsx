      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-center">
          ...
          <div className="border border-seth-coral/30 p-8 md:p-10 rounded-lg flex flex-col">
            <h3 className="text-seth-coral text-3xl md:text-4xl mb-6">{t('executive.title')}</h3>
          ...
          {/* Active Member Card */}
          <div className="border border-seth-coral/30 p-8 md:p-10 rounded-lg flex flex-col">
            <h3 className="text-seth-coral text-3xl md:text-4xl mb-6">{t('active.title')}</h3>
            <p className="text-seth-coral mb-8 flex-grow">
          ...
          <div className="border border-seth-coral/30 p-8 md:p-10 rounded-lg flex flex-col">
            <h3 className="text-seth-coral text-3xl md:text-4xl mb-6">{t('collab.title')}</h3>
            <p className="text-seth-coral mb-8 flex-grow">
